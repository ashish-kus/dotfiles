{
  ...
  "modules-right": ["hyprland/window", "tray", "custom/updates", "custom/clipboard", "group/blight", "idle_inhibitor", "custom/colorpicker", "bluetooth", "group/audio", "custom/hotspot", "group/networking",  "battery"],
...
"custom/hotspot": {
  ...
  "exec":"~/.config/waybar/scripts/hotspot.sh -a watch",
  "on-click":"~/.config/waybar/scripts/hotspot.sh -a toggle"
},
